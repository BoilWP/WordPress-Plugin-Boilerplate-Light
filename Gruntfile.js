...
grunt.initConfig({
  pkg: grunt.file.readJSON('package.json'),
    ...
    makepot: {
      target: {
        options: {
          domainPath: 'wordpress-plugin-boilerplate-light/languages/',    // Where to save the POT file.
          exclude: ['build/.*'],
          mainFile: 'wordpress-plugin-boilerplate-light/wordpress-plugin-boilerplate-light.php',    // Main project file.
          potComments: 'WordPress Plugin Boilerplate Copyright (c) {{year}}',      // The copyright at the beginning of the POT file.
          potFilename: 'wordpress-plugin-boilerplate-light.pot',    // Name of the POT file.
          ...
          processPot: function( pot, options ) {
            ...
            pot.headers['last-translator'] = 'WordPress Plugin Boilerplate Light <mailme@sebastiendumont.com>\n';
    ...
    exec: {
      ...
      txpush_s: { // Push pot to Transifex - grunt exec:txpush_s
        cmd: 'tx push -s'
         ...
         dirs: {
    lang: 'wordpress-plugin-boilerplate-light/languages',
    },
