 ...
 * Network:           false
 * GitHub Plugin URI: https://github.com/BoilWP/WordPress-Plugin-Boilerplate-Light
 *
 * WordPress Plugin Boilerplate Light is distributed under the terms of the
 * GNU General Public License as published by the Free Software Foundation,
 * either version 2 of the License, or any later version.
 *
 * WordPress Plugin Boilerplate Light is distributed in the hope that it will
 * be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
 * GNU General Public License for more details.
 *
 * You should have received a copy of the GNU General Public License
 * along with WordPress Plugin Boilerplate Light.
...
final class Plugin_Name {
	 ...
	 * @var    string
	 */
	public $text_domain = 'wordpress-plugin-boilerplate-light';
	 ...
	 * @var    string
	 */
	public $name = "WordPress Plugin Boilerplate Light";
	 ...
	 * @var    string
	 */
	public $doc_url = "https://github.com/BoilWP/WordPress-Plugin-Boilerplate-Light/wiki/";
	...
	public function action_links( $links ) {
		if( current_user_can( $this->manage_plugin ) ) {
			$plugin_links = array(
				'<a href="' . admin_url( 'admin.php?page=' . PLUGIN_NAME_PAGE . '-settings' ) . '">' . __( 'Settings', 'wordpress-plugin-boilerplate-light' ) . '</a>',
				'<a href="' . $this->wp_plugin_support_url . '" target="_blank">' . __( 'Support', 'wordpress-plugin-boilerplate-light' ) . '</a>'
			);
	...
	public function plugin_row_meta( $input, $file ) {
		...
		$links = array(
			'<a href="' . esc_url( apply_filters( 'plugin_name_documentation_url', $this->doc_url ) ) . '">' . __( 'Documentation', 'wordpress-plugin-boilerplate-light' ) . '</a>',
		);
	...
	static function display_req_notice() {
		...
		echo sprintf( __('Sorry, %s requires WordPress ' . PLUGIN_NAME_WP_VERSION_REQUIRE . ' or higher. Please upgrade your WordPress setup', 'wordpress-plugin-boilerplate-light'), PLUGIN_NAME );
		echo '</strong></p></div>';
	...
	private function register_scripts_and_styles() {
		if ( is_admin() ) {
			...
			wp_localize_script( $this->plugin_slug . '_admin_script', 'plugin_name_admin_params', apply_filters( 'plugin_name_admin_params', array(
				...
				'no_result'          => __( 'No results', 'wordpress-plugin-boilerplate-light' ),
				'plugin_url'         => $this->plugin_url(),
				'i18n_nav_warning'   => __( 'The changes you made will be lost if you navigate away from this page.', 'wordpress-plugin-boilerplate-light' ),
				'full_settings_menu' => $this->full_settings_menu,
				'plugin_menu_name'   => $this->menu_name,
				'plugin_screen_id'   => PLUGIN_NAME_SCREEN_ID,
				'_tab_one'           => __( 'First Tab', 'wordpress-plugin-boilerplate-light' ),
				'_tab_two'           => __( 'Second Tab', 'wordpress-plugin-boilerplate-light' ),
			) ) );
